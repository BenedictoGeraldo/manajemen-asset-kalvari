        ...
        <form method="POST" action="{{ route('transaksi.peminjaman.handover', $peminjaman->id) }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                ...
                <div>
                    ...
                    <textarea id="catatan_serah_terima" name="catatan_serah_terima" rows="2" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('catatan_serah_terima') }}</textarea>
                </div>
            </div>
