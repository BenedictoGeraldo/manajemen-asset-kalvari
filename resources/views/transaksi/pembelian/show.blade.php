    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex space-x-2 items-center">
            ...
            <form action="{{ route('transaksi.pembelian.approve', $pembelian->id) }}" method="POST" onsubmit="return confirm('Setujui pembelian ini dan posting ke data aset?')" class="inline-flex">
                @csrf
                <button type="submit" class="inline-flex items-center px-4 py-2 bg-green-600 hover:bg-green-700 text-white text-sm font-medium rounded-lg transition-colors duration-150" title="Setujui & Posting">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button type="button"
                    ...
                    class="inline-flex items-center px-4 py-2 bg-red-600 hover:bg-red-700 text-white text-sm font-medium rounded-lg transition-colors duration-150" title="Hapus">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
