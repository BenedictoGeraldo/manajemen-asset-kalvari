    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form action="{{ route('transaksi.mutasi_aset.complete', $mutasiAset->id) }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <textarea id="catatan" name="catatan" rows="4" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:border-blue-500 focus:ring-blue-500" placeholder="Catatan pelengkap tentang penyelesaian mutasi">{{ old('catatan', $mutasiAset->catatan ?? '') }}</textarea>
                @error('catatan')
            ...
            <div class="flex gap-3 pt-4 border-t">
                <button type="submit" class="btn-export-sm inline-flex items-center gap-2">
