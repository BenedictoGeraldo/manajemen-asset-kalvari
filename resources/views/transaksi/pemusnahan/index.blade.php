    ...
    <div class="mb-6">
        <div class="w-full flex flex-col sm:flex-row sm:items-center sm:space-x-4 space-y-2 sm:space-y-0">
            ...
            <div class="flex space-x-3 mt-2 sm:mt-0">
                @if(auth()->user()->is_super_admin || auth()->user()->hasPermission('transaksi.pemusnahan.create'))
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex space-x-2">
                                    ...
                                    @if(auth()->user()->is_super_admin || auth()->user()->hasPermission('transaksi.pemusnahan.delete'))
