...
<div class="bg-white rounded-lg shadow p-6 content-fade-in">
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex space-x-2">
            <a href="{{ route('pemusnahan.create') }}" class="btn-primary flex items-center">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50 transition-colors duration-150">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <a href="{{ route('pemusnahan.show', $p->id) }}" class="text-blue-600 hover:text-blue-900 mr-3">Detail</a>
                    </td>
                </tr>
                @empty
                <tr>
