...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Permission-group logic: view uncheck cascades
    ...
    // Allow clicking the row label area to toggle
    document.querySelectorAll('.perm-row').forEach(row => {
        row.addEventListener('click', function(e) {
            if (e.target.closest('.toggle-track')) return; // already handled
