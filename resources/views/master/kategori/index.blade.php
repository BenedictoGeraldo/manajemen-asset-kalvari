    ...
    <div class="mb-6">
        <div class="w-full flex flex-col sm:flex-row sm:items-center sm:space-x-4 space-y-2 sm:space-y-0">
            <form method="GET" class="flex-1">
                <input type="text" name="search" value="{{ $search ?? '' }}" placeholder="Cari kategori berdasarkan nama atau deskripsi..."
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex space-x-2">
                                    ...
                                    <button type="button" @click="$dispatch('delete-modal', { id: {{ $kategori->id }}, name: '{{ $kategori->nama_kategori }}' })" class="action-delete">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
