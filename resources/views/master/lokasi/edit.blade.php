        ...
        <div class="bg-white rounded-lg shadow p-6">
            <form action="{{ route('master.lokasi.update', $lokasi->id) }}" method="POST">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_lokasi" id="nama_lokasi" required
                               value="{{ old('nama_lokasi', $lokasi->nama_lokasi) }}" placeholder="Contoh: Gereja"
                    ...
                    <div>
                        ...
                        <input type="text" name="sub_lokasi" id="sub_lokasi"
                               value="{{ old('sub_lokasi', $lokasi->sub_lokasi) }}" placeholder="Contoh: Area Umat Gereja"
                    ...
                    <div>
                        ...
                        <textarea name="keterangan_lokasi" id="keterangan_lokasi" rows="3"
                                  class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('keterangan_lokasi', $lokasi->keterangan_lokasi) }}</textarea>
                    </div>
                ...
                <div class="mt-6 flex items-center space-x-3">
                    <button type="submit" class="btn-a-sm">Perbarui</button>
