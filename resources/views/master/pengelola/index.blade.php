    ...
    <div class="mb-6">
        <div class="w-full flex flex-col sm:flex-row sm:items-center sm:space-x-4 space-y-2 sm:space-y-0">
            <form method="GET" class="flex-1">
                <input type="text" name="search" value="{{ $search ?? '' }}" placeholder="Cari pengelola berdasarkan nama, jabatan, departemen, atau kontak..."
            ...
            <div class="flex space-x-3 mt-2 sm:mt-0">
                <div class="relative" x-data="{ open: false }">
                    ...
                    <div x-show="open"
                        ...
                        <div class="py-1">
                            <a href="{{ route('master.pengelola.export', 'xlsx') }}"
                            ...
                            <a href="{{ route('master.pengelola.export', 'csv') }}"
                               class="dropdown-export-item block">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($pengelolas as $index => $pengelola)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">{{ $pengelola->data_aset_count }} aset</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex space-x-2">
                                    <a href="{{ route('master.pengelola.show', $pengelola->id) }}" data-navigate
                                       class="action-view" title="Lihat Detail & Aset yang Dikelola">
