...
class UpdateDataAsetRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'gambar_aset' => 'nullable|image|mimes:jpeg,jpg,png,webp|max:2048',
            'hapus_gambar_aset' => 'nullable|boolean',
    ...
    public function attributes(): array
    {
        return [
            ...
            'gambar_aset' => 'gambar aset',
            'hapus_gambar_aset' => 'hapus gambar aset',
            'lokasi_id' => 'lokasi',
            'kegunaan' => 'kegunaan',
